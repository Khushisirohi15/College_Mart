...
const Signin = () => {
  ...
  const postData = async (e) => {
    ...
    if(domain!='miet.ac.in')
    {
      return alert("Only miet email ID's allowed.");
    }
    ...
    if (data.status === 422 || !data) {
      ...
      window.alert("Only MIET ID's allowed");
    } 
      ...
      >
        <div class="form-container sign-up-container">
          <form action="#">
            ...
            <span id="Span">Use your @miet.ac.in email for registration</span>
            <input
              type="text"
              name="name"
              value={user.name}
